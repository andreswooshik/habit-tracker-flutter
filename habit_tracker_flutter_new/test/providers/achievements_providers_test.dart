...
void main() {
  ...
  group('Phase 5: Achievements Providers - achievementsProvider', () {
    ...
    test('generates multiple achievements for 7-day streak', () {
      ...
      expect(achievements.any((a) => a.type == AchievementType.firstCompletion),
          isTrue);
      expect(
          achievements.any((a) => a.type == AchievementType.streak3), isTrue);
      expect(
          achievements.any((a) => a.type == AchievementType.streak7), isTrue);
      expect(
          achievements.any((a) => a.type == AchievementType.perfect7), isTrue);
    });
    ...
    test('generates achievements for 30-day streak', () {
      ...
      expect(
          achievements.any((a) => a.type == AchievementType.streak30), isTrue);
      expect(
          achievements.any((a) => a.type == AchievementType.perfect30), isTrue);
    });
  ...
  group('Phase 5: Consistency Providers - habitConsistencyProvider', () {
    ...
    test('returns 0.0 for nonexistent habit', () {
      final consistency =
          container.read(habitConsistencyProvider('nonexistent'));
